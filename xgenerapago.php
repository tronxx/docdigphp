...
<html>
<head>
  <title>Prueba de Facturacion en Producción</title>
</head>
<body>
<table border="1">
  <tr>
    <td> Generando Documento de Pago:</td>
  </tr>
...
<?php 
  ...
  $factura_z = json_decode(file_get_contents("d1.json"), true);
  $date = new DateTime();
  ...
  echo "Facturacion empresa_api_key:" .  $factura_z["meta"]["empresa_api_key"] . "<br>";
      ...
      $factura_z["data"][0]["cfdi__complemento"]["pago10__pagos"]["pago10__pago"][0]["fecha_pago"] = $date->format('Y-m-d\TH:i:s');  
